...
const register = async (
	...
	if (!(invalidEmail || invalidJobType || invalidPassword || invalidPhone)) {
		...
		if (
			...
			let signup_res = await axios.post(`${config.server}/signup`, {
				username,
				pass_hash,
				email,
				phone,
			...
			if (signup_res && signup_res.data && signup_res.data.username) {
				props.setRegister(false);
			} else if (
				signup_res &&
				signup_res.data &&
				!signup_res.data.username
			) {
